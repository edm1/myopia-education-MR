...
# Args
in_exposure = "1_split_sample_weights/output/eaInstr_stats_splitB.tsv"
in_outcome =  "1_split_sample_weights/output/eaInstr_stats_splitA.tsv"
outname = "output/EducationB_RefractiveErrorA"
