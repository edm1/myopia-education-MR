...
awk 'NR != 1 {print $1}' $arg_myopia_instruments | sort > $snp_list
...
outname=output/Myopia_UKBB_Pickrell.dosage
python merge_weights_to_dosage.py $outpref.dosages $arg_myopia_instruments \
